    ...
    public partial class ViewReservationList : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Functions.Functions.gen = "UPDATE reservations SET reservationstatus='" + cmbstatus.Text + "',approvedby='" + Form1.setfullname + "' where eventname = '" + txteventname.Text + "' and facilityname = '" + facilitycb.SelectedItem.ToString() + "'";
